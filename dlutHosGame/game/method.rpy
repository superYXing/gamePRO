...
label day1_start:
    ...
    $ speak_success = speak_text_and_play(patient_first_message, voice="nova")
...
label day1_choice_result:
    ...
    # 实时生成并播放患者语音 - 使用异步播放
    $ print("[TTS播放] 开始播放患者语音...")
    $ speak_success = speak_text_and_play(patient_second_message, voice="nova")
...
label day1_choice_result2:
    ...
    # 实时生成并播放患者语音 - 使用异步播放
    $ print("[TTS播放] 开始播放患者语音...")
    $ speak_success = speak_text_and_play(patient_third_message, voice="nova")
...
label day1_choice_result3:
    ...
    $ speak_success = speak_text_and_play(patient_satisfaction_message, voice="nova")
